...
file = open("/home/student/CS4300/homework1/src/task6_read_me.txt")

content = file.read()
# print(content)

with open ("/home/student/CS4300/homework1/src/task6_read_me.txt", "w",encoding='utf-8') as file:
...
with open(r'/home/student/CS4300/homework1/src/task6_read_me.txt','r') as file:
    data = file.read()
    lines = data.split()
